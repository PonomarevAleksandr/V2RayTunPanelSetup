...
One-command installer for the V2RayTun Panel. No GitHub token, no source clone, no manual configuration. Pulls pre-built Docker images from a private registry (the panel source itself stays private — only this installer is public).
